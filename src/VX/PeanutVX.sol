...
contract PeanutVX is IERC721Receiver, IERC1155Receiver, ReentrancyGuard {
    ...
    event WithdrawEventXChain(
        uint256 indexed _index, uint8 indexed _contractType, uint256 _amount, address indexed _recipientAddress, bytes callResult
    );
