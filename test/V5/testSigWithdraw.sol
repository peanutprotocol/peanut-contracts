...
contract TestSigWithdrawEther is Test {
    ...
    function testSigWithdrawEther(uint64 amount) public {
        vm.assume(amount > 0);
        uint256 depositIdx = peanutV5.makeDeposit{value: amount}(address(0), 0, amount, 0, _pubkey20);
        peanutV5.withdrawDeposit(depositIdx, _recipientAddress, _recipientAddressHashEip191, signature);
    }
}
